...
st.markdown('<div style="position: fixed; bottom: 0; right: 1550px;"><p style="color: grey; font-size: 14px;font-family: Barlow;">Criado por Pedro Dantas</p></div>', unsafe_allow_html=True)
